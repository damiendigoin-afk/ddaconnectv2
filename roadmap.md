...
- [ ] Phase C1 : import WinMotor (entêtes+détail), historique fiches, recherche facture, contrôle WinMotor, sortie finale stock — audit SQL, câblage menus, tests, build, recette visuelle. Bloqué pour import réel : vrais CSV à tester par l'utilisateur.
